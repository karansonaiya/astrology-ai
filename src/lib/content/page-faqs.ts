...
export const PANCHANG_FAQS: Faq[] = [
  {
    ...
    a: {
      en: "A Panchang is a traditional Hindu calendar. For a given day and place, it lays out five elements: tithi (lunar day), nakshatra (star constellation), yoga, karana, and vaara (weekday), along with sunrise/sunset and auspicious/inauspicious timing windows.",
      hi: "पंचांग एक पारंपरिक हिंदू कैलेंडर है। यह किसी दिन और स्थान के लिए पांच तत्व बताता है: तिथि, नक्षत्र, योग, करण, और वार, साथ ही सूर्योदय/सूर्यास्त और शुभ-अशुभ समय भी।",
      gu: "પંચાંગ એક પરંપરાગત હિન્દુ કૅલેન્ડર છે. તે કોઈ દિવસ અને સ્થળ માટે પાંચ તત્વો બતાવે છે: તિથિ, નક્ષત્ર, યોગ, કરણ, અને વાર, સાથે સૂર્યોદય/સૂર્યાસ્ત અને શુભ-અશુભ સમય પણ.",
    },
  },
  {
    q: {
  ...
  },
  {
    ...
    a: {
      en: "Alongside choghadiya, the page also shows named windows like Abhijit Muhurat and Amrit Kaal (auspicious) and Rahu Kaal, Yamaganda, Gulika (inauspicious). These come from a separate, older calculation method traditionally used for timing important events. Both are shown together since they're commonly consulted side by side.",
      hi: "चौघड़िया के साथ-साथ, पेज पर अभिजीत मुहूर्त और अमृत काल (शुभ) तथा राहु काल, यमगंड, गुलिक (अशुभ) जैसे नामित समय भी दिखाए जाते हैं। ये एक अलग, पुरानी गणना पद्धति से आते हैं जो पारंपरिक रूप से ज़रूरी कार्यों का समय तय करने के लिए इस्तेमाल होती है। दोनों को साथ दिखाया जाता है क्योंकि इन्हें अक्सर एक साथ देखा जाता है।",
      gu: "ચોઘડિયાની સાથે, પેજ પર અભિજિત મુહૂર્ત અને અમૃત કાળ (શુભ) તથા રાહુ કાળ, યમગંડ, ગુલિક (અશુભ) જેવા નામાંકિત સમય પણ બતાવાય છે. આ એક અલગ, જૂની ગણતરી પદ્ધતિમાંથી આવે છે જે પરંપરાગત રીતે જરૂરી કાર્યોનો સમય નક્કી કરવા વપરાય છે. બંનેને સાથે બતાવાય છે કેમ કે તેમને ઘણીવાર સાથે જ જોવાય છે.",
    },
  },
  {
    q: {
  ...
  },
  {
    ...
    a: {
      en: "It's a real astronomical calculation (Lahiri ayanamsa, sidereal), not AI-generated text. It's the same underlying math a printed panchang uses, just computed for your exact city and date rather than a generic regional one.",
      hi: "यह एक वास्तविक खगोलीय गणना है (लाहिड़ी अयनांश, सायडेरियल), AI-जनित टेक्स्ट नहीं। यह वही गणित है जो छपे हुए पंचांग में इस्तेमाल होता है, बस आपके सटीक शहर और तारीख़ के लिए, किसी सामान्य क्षेत्रीय पंचांग की जगह।",
      gu: "આ એક ખરી ખગોળીય ગણતરી છે (લાહિરી અયનાંશ, સાયડેરિયલ), AI-જનિત ટેક્સ્ટ નથી. આ એ જ ગણિત છે જે છપાયેલા પંચાંગમાં વપરાય છે, બસ તમારા ચોક્કસ શહેર અને તારીખ માટે, કોઈ સામાન્ય પ્રાદેશિક પંચાંગને બદલે.",
    },
  },
];
...
export const HOROSCOPE_FAQS: Faq[] = [
  ...
  },
  {
    ...
    a: {
      en: "This page's reading is general. Everyone with that sun sign sees the same one, based on real current planetary transits. For a reading grounded in your own exact chart (moon sign, ascendant, houses), use Ask Prerna AI or the Kundli page after signing in.",
  ...
  },
  {
    ...
    a: {
      en: "They're generated alongside the rest of the reading, grounded in the same day's real transit data. It's not a random pick, though it is a lighter, more playful part of the reading than the career/love/health sections.",
      hi: "ये बाक़ी पढ़ाव के साथ ही, उसी दिन के असली गोचर डेटा पर आधारित होकर बनते हैं। यह कोई बेतरतीब चुनाव नहीं है, हालांकि ये करियर/प्रेम/स्वास्थ्य वाले हिस्सों की तुलना में हल्का, ज़्यादा मनोरंजक हिस्सा है।",
      gu: "આ બાકીના વાંચનની સાથે જ, એ જ દિવસના ખરા ગોચર ડેટા પર આધારિત થઈને બને છે. આ કોઈ રેન્ડમ પસંદગી નથી, જોકે આ કરિયર/પ્રેમ/આરોગ્ય વાળા ભાગો કરતાં હળવો, વધુ મનોરંજક ભાગ છે.",
    },
  },
];
...
export const BLOG_FAQS: Faq[] = [
  {
    ...
    a: {
      en: "Match your birth date against the date ranges on this page. Note that these are Vedic (sidereal) ranges, which run about 3-4 weeks later than the Western dates most horoscope columns use. For your exact moon sign and ascendant too, not just the sun sign, use the Kundli page after signing in.",
      hi: "इस पेज पर दी गई तारीख़ सीमाओं से अपनी जन्म तारीख़ मिलाएं। ध्यान दें कि ये वैदिक (सायडेरियल) सीमाएं हैं, जो ज़्यादातर राशिफल कॉलम में इस्तेमाल होने वाली पश्चिमी तारीख़ों से लगभग 3-4 हफ़्ते बाद शुरू होती हैं। सिर्फ़ सूर्य राशि नहीं, अपनी सटीक चंद्र राशि और लग्न के लिए भी, साइन इन करने के बाद Kundli पेज इस्तेमाल करें।",
      gu: "આ પેજ પર આપેલી તારીખ મર્યાદાઓ સાથે તમારી જન્મ તારીખ સરખાવો. નોંધો કે આ વૈદિક (સાયડેરિયલ) મર્યાદાઓ છે, જે મોટાભાગના રાશિફળ કૉલમમાં વપરાતી પશ્ચિમી તારીખો કરતાં લગભગ 3-4 અઠવાડિયા મોડી શરૂ થાય છે. ફક્ત સૂર્ય રાશિ નહીં, તમારી ચોક્કસ ચંદ્ર રાશિ અને લગ્ન માટે પણ, સાઇન ઇન કર્યા પછી Kundli પેજ વાપરો.",
    },
  },
  {
    q: {
    ...
    a: {
      en: "Most casual horoscope sources use the Western tropical zodiac. This app uses the Vedic sidereal zodiac (Lahiri ayanamsa) throughout, the same system its real astrology calculations run on. So the blog's dates match the app's own kundli/horoscope engine rather than a different convention.",
      hi: "ज़्यादातर आम राशिफल स्रोत पश्चिमी ट्रॉपिकल राशिचक्र इस्तेमाल करते हैं। यह ऐप हर जगह वैदिक सायडेरियल राशिचक्र (लाहिड़ी अयनांश) इस्तेमाल करता है, जो इसकी असली ज्योतिष गणना वाली ही प्रणाली है। इसलिए ब्लॉग की तारीख़ें किसी अलग परंपरा की बजाय ऐप की अपनी कुंडली/राशिफल प्रणाली से मेल खाती हैं।",
      gu: "મોટાભાગના સામાન્ય રાશિફળ સ્રોત પશ્ચિમી ટ્રોપિકલ રાશિચક્ર વાપરે છે. આ એપ બધે વૈદિક સાયડેરિયલ રાશિચક્ર (લાહિરી અયનાંશ) વાપરે છે, જે તેની ખરી જ્યોતિષ ગણતરી વાળી જ પદ્ધતિ છે. એટલે બ્લોગની તારીખો કોઈ અલગ પરંપરાને બદલે એપની પોતાની કુંડળી/રાશિફળ પદ્ધતિ સાથે મળે છે.",
    },
  },
  {
    q: {
    ...
    a: {
      ...
      hi: "वैदिक ज्योतिष में, हर राशि पारंपरिक रूप से एक ग्रह से जुड़ी होती है जिसके गुण उस राशि के स्वभाव को प्रभावित करते माने जाते हैं। जैसे मेष की स्पष्टवादिता के लिए मंगल, वृषभ के आराम-प्रेम के लिए शुक्र, वग़ैरह।",
      gu: "વૈદિક જ્યોતિષમાં, દરેક રાશિ પરંપરાગત રીતે એક ગ્રહ સાથે જોડાયેલી હોય છે જેના ગુણો એ રાશિના સ્વભાવને પ્રભાવિત કરતા મનાય છે. જેમ કે મેષની સ્પષ્ટવાદિતા માટે મંગળ, વૃષભના આરામ-પ્રેમ માટે શુક્ર, વગેરે.",
    },
  },
  {
    q: {
