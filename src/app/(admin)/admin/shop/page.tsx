...
type Inquiry = {
  id: string; contactName: string; contactPhone: string; message: string | null; status: string; createdAt: string;
  product: { name: string };
};
            ...
            <Card key={p.id}>
              <CardContent className="flex items-center justify-between py-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button size="sm" variant="danger" onClick={() => deleteProduct.mutate(p.id)}>Delete</Button>
                </div>
              </CardContent>
            </Card>
          ))}
